	...
	<body>
		<?php
			...
			if (!get_magic_quotes_gpc()){
				...
				$class = mysql_real_escape_string(addslashes($_POST['class']));
				$phonenum = mysql_real_escape_string(addslashes($_POST['phonenum']));
				$qqnum = mysql_real_escape_string(addslashes($_POST['qqnum']));
				$department = mysql_real_escape_string(addslashes($_POST['department']));
				$department1 = mysql_real_escape_string(addslashes($_POST['department1']));
				$department2 = mysql_real_escape_string(addslashes($_POST['department2']));
				$department3 = mysql_real_escape_string(addslashes($_POST['department3']));
				$introduction = mysql_real_escape_string(addslashes($_POST['introduction']));
				$verify   = mysql_real_escape_string(addslashes($_POST['verify']));
			}
			if($verify != $verify1){
